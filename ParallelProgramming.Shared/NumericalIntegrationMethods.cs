...
namespace ParallelProgramming.Shared
{
    public class NumericalIntegrationMethods
    {
		...
		public double RectangularMethod(double xp, double xk, int n, int maxThreads)
        {
		...
		public double TrapezoidalIntegration(double xp, double xk, int n, int maxThreads)
        {
			double dx, integral = 0;
			dx = (xk - xp) / n;
		...
		public double SimpsonsIntegration(double xp, double xk, int n, int maxThreads)
		{
